...
instance Print TopDef where
  prt i e = case e of
    ...
    ClDef id memberdefs -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 memberdefs, doc (showString "}")])
    DepClDef id1 id2 memberdefs -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 memberdefs, doc (showString "}")])
...
instance Print MemberDef where
  prt i e = case e of
    MAttr type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
    MMethod type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Stmt where
  prt i e = case e of
    Alloc expr type_ -> prPrec i 0 (concatD [prt 0 expr, doc (showString "="), doc (showString "new"), prt 0 type_])
    ArrAlloc expr1 type_ expr2 -> prPrec i 0 (concatD [prt 0 expr1, doc (showString "="), doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr2, doc (showString "]")])
    ...
    Ass expr1 expr2 -> prPrec i 0 (concatD [prt 0 expr1, doc (showString "="), prt 0 expr2, doc (showString ";")])
    ...
    SFor type_ id1 id2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id1, doc (showString ":"), prt 0 id2, doc (showString ")"), prt 0 stmt])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print Item where
  prt i e = case e of
    ...
    InitAlloc id type_ -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), doc (showString "new"), prt 0 type_])
    ArrIAlloc id type_ expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
...
instance Print Expr where
  prt i e = case e of
    EArrAcc expr1 expr2 -> prPrec i 6 (concatD [prt 6 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    ENull type_ -> prPrec i 6 (concatD [doc (showString "("), prt 0 type_, doc (showString ")null")])
...
instance Print RelOp where
  prt i e = case e of
    L -> prPrec i 0 (concatD [doc (showString "<")])
    LE -> prPrec i 0 (concatD [doc (showString "<=")])
    G -> prPrec i 0 (concatD [doc (showString ">")])
    GE -> prPrec i 0 (concatD [doc (showString ">=")])
    E -> prPrec i 0 (concatD [doc (showString "==")])
